class InitSchema < ActiveRecord::Migration[6.1]
  def up
    ...
    create_table "answered_questions", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
    ...
    create_table "classroom_admins", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
    ...
    create_table "classrooms_exercices", id: false do |t|
      t.uuid "classroom_id", null: false
    ...
    create_table "courses_exercices", id: false do |t|
      t.uuid "course_id", null: false
      t.uuid "exercice_id", null: false
    end
    create_table "exercices", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.string "name"
      t.string "slug"
      t.boolean "published"
      t.uuid "course_id", null: false
    ...
    create_table "levels", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.string "title"
      t.string "slug"
      t.uuid "user_id", null: false
      t.datetime "created_at", precision: 6, null: false
