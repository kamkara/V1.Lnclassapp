...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { name: @school.name, slug: @school.slug, user_id: @school.user_id } }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { name: @school.name, slug: @school.slug, user_id: @school.user_id } }
